---
type: video-scripts
brands: personal (3) + engine-room-nutrition (3)
generated_at: 2026-09-08
rules: HF6 OST · HF13 verbal hook · P63 dream outcome and cost, answer
  withheld · P64 pain first, then cost of staying, then dream outcome ·
  P50 full sentences · P55 condensed · P39 every claim sourced or
  flagged · P60 no negative parallelism · P66 follows, saves, watch
  time, and one unresolved thread in every video · P68 search build on
  the last one
---

# Six scripts

**Standing structure, used in all six.** Every line has to make the
next line worth staying for.

1. OST, held about 10 seconds
2. Verbal hook: the pain, the cost of staying in it, the dream
   outcome, then a loop with the answer withheld
3. Aha 1, the frame, never the fix
4. Silent on-screen credential
5. Aha 2, the mechanism nobody explains
6. The items, each carrying its own consequence
7. Payoff, then an unresolved thread
8. CTA aimed at saves and follows, never comments

⚑ = a fact or number to confirm before filming.
...
**[THREAD + CTA]**
"Next one is the check I run mid-run to know I am actually on level
three. Save this for your next easy day."
